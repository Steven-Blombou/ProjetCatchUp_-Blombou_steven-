...
-- Généré le : ven. 01 mai 2020 à 13:24
...
(2, 'test2', 'test2', 'test2', 'password_user', 'test5@live.fr', 3, '', 0, '0000-00-00 00:00:00'),
(3, 'test3', 'test3', 'test3', 'password_user', 'test5@live.fr', 3, 'aTjWqwRXF2Mlw2lMXstsAtXHRoGlcJVZKDMvfqQQkM2xqHAho9UA6Rv1RF7a', 0, NULL),
(4, 'test4', 'test4', 'test4', 'test4', 'test5@live.fr', 3, 'A31JJngdmXCh2NFapecNJjNlXQ8LQ7JOchfi6HcNLYpkpQhSvZDZWRaEMJJE', 1, NULL),
(5, 'test5', 'test5', 'test5', '$2y$10$ZUakkzvBT8Kz72VYejHeo.4j1oiUiesy2xFnXQklAGyNFllG2tbIG', 'test5@live.fr', 3, '0GqxoGUTNwK78TfhunVc0cjnZlFIZhTOQvp7THBGQ65bRGjYC9C9nnGsD5FX', 1, NULL);
