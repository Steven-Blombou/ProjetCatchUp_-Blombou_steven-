                        ...
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="login-search-area d-flex align-items-center">
                                ...
                                <div class="login d-flex">
                                  ...
                                  {
                                  echo ("<li>");
                                  echo ("<a href='Login/account.php'>" . "bonjour" . "&nbsp" . $_SESSION['username'] . "</a>"); // "&nbsp"=espace en php  J etablie la connexion et j affiche le message
                                            ...
                                            <div class="single-mega cn-col-4">
                                                ...
                                                <div class="single-blog-post small-featured-post d-flex">
                                                    <div class="post-thumb">
                                                        <a href="#"><img src="public/img/bg-img/23.jpg" alt=""></a>
                                                    </div>
                                                    <div class="post-data">
                                                ...
                                                <div class="single-blog-post small-featured-post d-flex">
                                                    <div class="post-thumb">
                                                        <a href="#"><img src="public/img/bg-img/24.jpg" alt=""></a>
                                                    </div>
                                                    <div class="post-data">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-4">
                    <div class="hero-add">
                        <a href="#"><img src="public/img/bg-img/hero-add.gif" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="single-blog-post featured-post">
                                <div class="post-thumb">
                                    <a href="#"><img src="public/img/bg-img/16.jpg" alt=""></a>
                                </div>
                                <div class="post-data">
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="single-blog-post featured-post-2">
                                <div class="post-thumb">
                                    <a href="#"><img src="public/img/bg-img/17.jpg" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <div class="post-meta">
                            ...
                            <div class="single-blog-post featured-post-2">
                                <div class="post-thumb">
                                    <a href="#"><img src="public/img/bg-img/18.jpg" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-catagory">Finance</a>
                                    <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="public/img/bg-img/19.jpg" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-catagory">Finance</a>
                            <div class="post-meta">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="public/img/bg-img/20.jpg" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-catagory">Politics</a>
                            <div class="post-meta">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="public/img/bg-img/21.jpg" alt=""></a>
                        </div>
                        <div class="post-data">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        <div class="post-thumb">
                            <a href="#"><img src="public/img/bg-img/22.jpg" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-catagory">Finance</a>
                            <div class="post-meta">
...
<div class="col-12 col-sm-6 col-md-4">
    <div class="single-video-post">
        <img src="public/img/bg-img/video1.jpg" alt="">
        <!-- Video Button -->
        <div class="videobtn">
...
<div class="col-12 col-sm-6 col-md-4">
    <div class="single-video-post">
        <img src="public/img/bg-img/video2.jpg" alt="">
        <!-- Video Button -->
        <div class="videobtn">
            <a href="https://www.youtube.com/watch?v=5BQr-j3BBzU" class="videoPlayer"><i class="fa fa-play" aria-hidden="true"></i></a>
        </div>
...
<div class="col-12 col-sm-6 col-md-4">
    <div class="single-video-post">
        <img src="public/img/bg-img/video3.jpg" alt="">
        <!-- Video Button -->
        <div class="videobtn">
            <a href="https://www.youtube.com/watch?v=5BQr-j3BBzU" class="videoPlayer"><i class="fa fa-play" aria-hidden="true"></i></a>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4">
            <div class="single-blog-post">
                <div class="post-thumb">
                    <a href="#"><img src="public/img/bg-img/1.jpg" alt=""></a>
                </div>
                <div class="post-data">
                    <a href="#" class="post-title">
        ...
        <div class="col-12 col-lg-4">
            <div class="single-blog-post">
                <div class="post-thumb">
                    <a href="#"><img src="public/img/bg-img/2.jpg" alt=""></a>
                </div>
                <div class="post-data">
                    <a href="#" class="post-title">
                        <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
        ...
        <div class="col-12 col-lg-4">
            <div class="single-blog-post">
                <div class="post-thumb">
                    <a href="#"><img src="public/img/bg-img/3.jpg" alt=""></a>
                </div>
                <div class="post-data">
                    <a href="#" class="post-title">
                        <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
        ...
        <div class="col-12 col-lg-4">
            <div class="single-blog-post">
                <div class="post-thumb">
                    <a href="#"><img src="public/img/bg-img/4.jpg" alt=""></a>
                </div>
                <div class="post-data">
                    <a href="#" class="post-title">
                        <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
        ...
        <div class="col-12 col-lg-4">
            <div class="single-blog-post">
                <div class="post-thumb">
                    <a href="#"><img src="public/img/bg-img/5.jpg" alt=""></a>
                </div>
                <div class="post-data">
                    <a href="#" class="post-title">
                        <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
        ...
        <div class="col-12 col-lg-4">
            <div class="single-blog-post">
                <div class="post-thumb">
                    <a href="#"><img src="public/img/bg-img/6.jpg" alt=""></a>
                </div>
                <div class="post-data">
                    <a href="#" class="post-title">
                        <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
...
<div class="col-12 col-md-5 col-lg-3">
    ...
    <div class="single-blog-post style-2">
        <div class="post-thumb">
            <a href="#"><img src="public/img/bg-img/7.jpg" alt=""></a>
        </div>
        <div class="post-data">
            <a href="#" class="post-title">
    ...
    <div class="single-blog-post style-2">
        <div class="post-thumb">
            <a href="#"><img src="public/img/bg-img/8.jpg" alt=""></a>
        </div>
        <div class="post-data">
            <a href="#" class="post-title">
                <h6>Orci varius natoque penatibus et magnis</h6>
    ...
    <div class="single-blog-post style-2">
        <div class="post-thumb">
            <a href="#"><img src="public/img/bg-img/9.jpg" alt=""></a>
        </div>
        <div class="post-data">
            <a href="#" class="post-title">
                <h6>Orci varius natoque penatibus et magnis</h6>
    ...
    <div class="single-blog-post style-2">
        <div class="post-thumb">
            <a href="#"><img src="public/img/bg-img/10.jpg" alt=""></a>
        </div>
        <div class="post-data">
            <a href="#" class="post-title">
                <h6>Orci varius natoque penatibus et magnis</h6>
    ...
    <div class="single-blog-post style-2">
        <div class="post-thumb">
            <a href="#"><img src="public/img/bg-img/11.jpg" alt=""></a>
        </div>
        <div class="post-data">
            <a href="#" class="post-title">
                <h6>Orci varius natoque penatibus et magnis</h6>
...
<div class="col-12">
    <div class="footer-add">
        <a href="#"><img src="public/img/bg-img/footer-add.gif" alt=""></a>
    </div>
</div>
</div>
</div>
